...
export const Debug = observer(() => {
  ...
  const cameraUpFlag = isFlagInBinaryMask(playerData.tileFlag, TWFlags.CameraUp);
  const characterFlag = isFlagInBinaryMask(playerData.tileFlag, TWFlags.Character);
  const heightFlag = isFlagInBinaryMask(playerData.tileFlag, TWFlags.Height);
  const noAttackZoneFlag = isFlagInBinaryMask(playerData.tileFlag, TWFlags.NoAttackZone);
